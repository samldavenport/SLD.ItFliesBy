...
namespace ifb {
    ...
    IFB_INTERNAL u32           file_read                             (file_manager* mngr, const file_handle hnd, const u32 buffer_size, cchar8*       buffer_ptr);
    IFB_INTERNAL u32           file_write                            (file_manager* mngr, const file_handle hnd, const u32 buffer_size, const cchar8* buffer_ptr);
