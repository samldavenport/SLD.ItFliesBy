...
namespace ifb {
    ...
    renderer_hello_quad_shader_init(
        ...
        auto& shdr = _renderer_ctx->shader.hello_quad;
        ...
        gl_ok &= gl_buffer_set_vertex_data     (_renderer_ctx->gl, shdr.gl.buf_vertex,  _quad_buffers.vertices.data, _quad_buffers.vertices.size);
        gl_ok &= gl_buffer_set_element_data    (_renderer_ctx->gl, shdr.gl.buf_element, _quad_buffers.elements.data, _quad_buffers.elements.size);
