...
mem_map_init(
    ...
    mem_map.cartographer.size = SIZE_RESERVATION;
    mem_map.cartographer.ptr  = VirtualAlloc(NULL, SIZE_RESERVATION, MEM_RESERVE, PAGE_READONLY);
