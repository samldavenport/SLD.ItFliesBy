...
namespace ifb {
    ...
    IFB_INTERNAL json_object*   json_doc_get_object           (const json_document* doc, const cchar* name, u32&    val);
    ...
    IFB_INTERNAL json_object*   json_object_get_object        (const json_object* obj, const cchar* name, u32&    val);
