...
namespace ifb {
    ...
    IFB_INTERNAL tiled_map*                   tiled_map_create             (eng_arena_handle a, const u32 json_src_length, const cchar* json_src_ptr);
    IFB_INTERNAL tiled_map*                   tiled_map_parse              (eng_arena_handle a, const json_obj* obj);
    IFB_INTERNAL tiled_layer*                 tiled_layer_parse_array      (eng_arena_handle a, const json_arr* arr, s32& count);
    ...
    IFB_INTERNAL tiled_tileset*               tiled_tileset_parse_array    (eng_arena_handle a, const json_arr* arr, s32& count);
    IFB_INTERNAL tiled_grid*                  tiled_grid_parse             (eng_arena_handle a, const json_obj* obj);
    IFB_INTERNAL tiled_tile_offset*           tiled_tile_offset_parse      (eng_arena_handle a, const json_obj* obj);
    IFB_INTERNAL tiled_transformations*       tiled_transformations_parse  (eng_arena_handle a, const json_obj* obj);
    IFB_INTERNAL tiled_tile*                  tiled_tile_parse             (eng_arena_handle a, const json_obj* obj);
    IFB_INTERNAL tiled_frame*                 tiled_frame_parse            (eng_arena_handle a, const json_obj* obj);
    IFB_INTERNAL tiled_terrain*               tiled_terrain_parse          (eng_arena_handle a, const json_obj* obj);
    ...
    IFB_INTERNAL tiled_property*              tiled_property_parse_array   (eng_arena_handle a, const json_arr* arr, s32& count);
    IFB_INTERNAL tiled_point*                 tiled_point_parse            (eng_arena_handle a, const json_obj* obj);
