...
@set eng_cl_include= /Iinclude /Isrc\collections /Isrc\components /Isrc\engine /Isrc\entities /Isrc\files /Isrc\gui /Isrc\memory /Isrc\physics /Isrc\quads /Isrc\renderer /Isrc\win32 /ISLD.Core\include /ISLD.OpenGL\include /ISLD.Math\include  /Ivcpkg_installed\x64-windows\include
