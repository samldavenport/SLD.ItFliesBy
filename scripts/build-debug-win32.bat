...
@set eng_cl_include= /Iinclude /Isrc\collections /Isrc\engine /Isrc\files /Isrc\renderer /Isrc\win32 /ISLD.Core\include /ISLD.OpenGL\include /ISLD.Math\include /Ivcpkg_installed\x64-windows\include
